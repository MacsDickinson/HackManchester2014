...
css_dir = "Content/Styles/css" # update to the path of your css files.
sass_dir = "Content/Styles/sass" # update to the path of your sass files.
images_dir = "Content/img" # update to the path of your image files.
